...
![No Caching](/blogs/img/web-cache-deception/no-caching.png)

![Caching](/blogs/img/web-cache-deception/caching.png)
...
![Retrieving data from application server because user’s request is not cached in cache server](/blogs/img/web-cache-deception/retrive-cache.png)
...
![Retrieving data from cache server because user’s request is cached ](/blogs/img/web-cache-deception/retrive-no-cache.png)
...
![https://www.darkreading.com/risk/deconstructing-web-cache-deception-attacks-they-re-bad-now-what-](/blogs/img/web-cache-deception/wcd.png)
...
![User Login](/blogs/img/web-cache-deception/user-login.png)

![A user-specific page that informs the amount of bank account](/blogs/img/web-cache-deception/user-specific.png)

![The request made to /nonexist.css (static resource) by methods such as social engineering, phishing, as a result (if the cache server is configured incorrectly) caching localhost://account.php/nonexist.css on the cache server](/blogs/img/web-cache-deception/leaked.png)

![Incognito tab, leaked amount of bank account!](/blogs/img/web-cache-deception/leaked2.png)
