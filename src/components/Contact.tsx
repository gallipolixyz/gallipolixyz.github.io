  ...
  return (
    <div className="min-h-screen bg-black text-custom-cyan pt-24 pb-20 px-4">
      <div className="max-w-4xl mx-auto">
              ...
              <button
                ...
                className={`flex flex-col items-center justify-center py-4 px-3 sm:px-6 rounded-xl font-mono text-sm sm:text-base transition-all duration-300 relative group border ${
                  isActive
                    ...
                    : 'border-custom-cyan/25 bg-[#030d11]/80 text-custom-cyan/60 hover:text-custom-cyan hover:border-custom-cyan/50 hover:bg-custom-cyan/5'
                }`}
              >
                <Icon
                  size={20}
        ...
        {/* Main Content Card */}
        <div className="rounded-2xl border border-custom-cyan/25 bg-[#030e12]/90 backdrop-blur-md p-6 sm:p-10 shadow-[0_0_35px_rgba(0,255,255,0.06)] relative overflow-hidden">
          {/* Subtle Ambient Background Glow */}
          <div className="absolute -top-32 -right-32 w-64 h-64 bg-custom-cyan/5 rounded-full blur-3xl pointer-events-none" />
          ...
          <AnimatePresence mode="wait">
            ...
            {activeTab === 'contact' && (
              ...
              >
                ...
                {/* Email Box Card */}
                <div className="rounded-2xl border border-custom-cyan/30 bg-[#021318]/70 p-8 sm:p-10 text-center relative overflow-hidden group hover:border-custom-cyan/50 transition-all duration-300">
                  ...
                  <span className="block text-xs font-mono tracking-widest text-custom-cyan/60 uppercase mb-2">
                    EMAIL ADDRESS
                  </span>
                  ...
                  <div className="flex flex-wrap items-center justify-center gap-4">
                    <a
                      ...
                      className="px-7 py-3.5 rounded-lg border border-custom-cyan/60 bg-custom-cyan/10 text-custom-cyan hover:border-white hover:bg-custom-cyan/20 hover:text-white font-mono text-sm sm:text-base font-medium flex items-center gap-2.5 transition-all duration-300 shadow-[0_0_12px_rgba(0,255,255,0.15)] hover:shadow-[0_0_20px_rgba(0,255,255,0.4)]"
                    >
                      <Send size={18} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                  <div className="rounded-xl border border-custom-cyan/20 bg-[#021318]/50 p-5 hover:border-custom-cyan/40 transition-colors">
                ...
                {/* Response Time Alert */}
                <div className="rounded-xl border border-custom-cyan/20 bg-[#021318]/40 p-4 text-center">
            ...
            {activeTab === 'career' && (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="rounded-xl border border-custom-cyan/20 bg-[#021318]/60 p-5 hover:border-custom-cyan/40 transition-colors">
                ...
                <div className="rounded-xl border border-custom-cyan/25 bg-[#021318]/50 p-6 sm:p-7">
